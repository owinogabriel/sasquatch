  ...
  return (
    <div>
      <div>
        ...
        <div>
          <h2>Introduction and extensible editor</h2>
          <p>Blogr feature an exceedingly intuitive interface which lets you focus <br />
        ...
        <div>
          ...
          <p>Flexible content management enables users to easily move through <br /> posts. Increase the usability of your blog by adding customized <br />
